"""Button platform for the Packeta parcel tracker integration."""
...
async def async_setup_entry(
    ...
    """Set up the Packeta refresh button from a config entry."""
    async_add_entities([PacketaRefreshButton(entry)])


class PacketaRefreshButton(ButtonEntity):
    """Button that forces an immediate poll of all tracked Packeta parcels."""
