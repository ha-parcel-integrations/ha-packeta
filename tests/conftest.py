"""pytest configuration for the Packeta test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.packeta`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.packeta import parcels

    parcels._unmapped_statuses_logged.clear()
    parcels._unparsed_time_logged = False
    yield
