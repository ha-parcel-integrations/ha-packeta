...
| Polling | Refresh every | 30 min | How often Packeta is checked. Slower is gentler on their API. |
...
This integration uses the same public tracking endpoint as the Packeta consumer website. It is not affiliated with, endorsed by, or supported by Packeta. Be gentle with the polling interval.
